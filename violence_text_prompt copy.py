...
def detect_violence(texts):
    ...
    :return: 분석 결과 딕셔너리
    """
    results = {"dialogues": []}  # 🎯 results를 딕셔너리로 초기화
        ...
        try:
            ...
            if answer:
                ...
                if json_start != -1 and json_end != -1:
                    ...
                    results["dialogues"].append(parsed_json)  # 🎯 results["dialogues"]에 추가
                else:
                    print("⚠️ API 응답에서 JSON 형식을 찾을 수 없습니다.")
...
def main():
    ...
    output_path = "C:/Users/kth45/work/핸섬가이즈_violence_text_prompt(7).json"  # 분석 결과 저장 경로
